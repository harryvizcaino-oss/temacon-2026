    ...
    <>
      ...
      >
        <div className="wrapper flex items-center justify-between w-full px-4 sm:px-6">
          ...
          {/* Desktop Nav — 3 text links + 3 buttons */}
          <div className="hidden lg:flex items-center gap-5 xl:gap-6">
            ...
            <a href="#agenda-speakers" className={`relative group text-sm font-medium transition-colors ${logoDark ? 'text-black hover:text-[#E31E24]' : 'text-white hover:text-[#E31E24]'}`}>
              Agenda
              <span className="absolute -bottom-1 left-1/2 -translate-x-1/2 w-0 h-0.5 bg-[#E31E24] rounded-full transition-all duration-300 group-hover:w-full" />
            </a>

            {/* CTA buttons — LinkedIn + Patrocinar + Comprar Ticket */}
      ...
      >
        ...
        >
          ...
          <div className="px-3 py-2 border-t border-white/10 bg-[#0a0a0a] flex flex-col gap-[6px]">
            <a
              href="#about"
              className="flex items-center justify-center gap-1.5 bg-white text-[#0a66c2] border-[2px] border-[#0a66c2] py-[7px] rounded-lg font-display font-semibold text-[12px] leading-tight hover:bg-[#0a66c2] hover:text-white transition-all"
              onClick={() => setMobileOpen(false)}
            >
