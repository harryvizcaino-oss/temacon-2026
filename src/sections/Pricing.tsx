        ...
        >
          <div className="relative rounded-xl lg:rounded-2xl overflow-hidden border border-black/[0.08] shadow-[0_0_60px_rgba(227,30,36,0.1)] bg-white">
            ...
            <div className="flex flex-col lg:flex-row">
              ...
              {/* COL 1: Flight Info */}
              <div className="flex-1 p-3 sm:p-4 lg:p-4 relative border-b lg:border-b-0 border-black/[0.06]">
                ...
                <div className="flex items-center gap-3 mb-1.5 lg:mb-2">
                  <div>
                    ...
                    <p className="font-display text-lg lg:text-xl text-black leading-tight">BOG</p>
                  ...
                  <div className="text-right">
                    ...
                    <p className="font-display text-lg lg:text-xl text-black leading-tight">T26</p>
                ...
                <div className="grid grid-cols-3 gap-1 lg:mb-0">
                  {[
                    ...
                    <div key={label} className="bg-black/[0.03] rounded-lg p-1.5 lg:p-2 border border-black/[0.06]">
                ...
                <div ref={stampRef} className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none opacity-0">
                  <div className="w-16 h-16 lg:w-20 lg:h-20 rounded-full border-[3px] border-[#E31E24] flex items-center justify-center bg-white/90 backdrop-blur-sm shadow-lg">
                    <div className="text-center">
                      <Stamp size={14} className="text-[#E31E24] mx-auto mb-0.5" />
                      <p className="font-display text-[9px] lg:text-[10px] text-[#E31E24] font-bold">CONFIRMED</p>
                      <p className="font-mono text-[5px] text-[#E31E24]/60">TEMACON 2026</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="hidden lg:flex lg:w-[240px] xl:w-[260px] p-3 sm:p-4 lg:p-4 flex-col justify-center gap-3">
                <div className="flex flex-col items-center justify-center">
                  <p className="font-mono text-[6px] lg:text-[7px] text-black/30 tracking-wider mb-1">PRECIO GENERAL</p>
                  <span className="font-display text-2xl lg:text-3xl text-black tracking-tight">$399,000</span>
                  <div className="flex items-center justify-center gap-2 mt-0.5">
                    <span className="font-mono text-[10px] text-black/40">+ IVA</span>
                    <span className="font-mono text-[9px] text-black/30">COP</span>
                  </div>
                </div>
                <button onClick={() => { MetaPixel.initiateCheckout(); setIsModalOpen(true); }}
                  className="w-full py-2.5 bg-[#E31E24] text-white rounded-lg font-display font-semibold text-xs hover:bg-[#c41a20] transition-all duration-300 shadow-lg shadow-[#E31E24]/20 flex items-center justify-center gap-2 cursor-pointer"
              ...
              <div className="hidden lg:block lg:w-[280px] xl:w-[300px] p-3 sm:p-4 lg:p-4">
            ...
            <div className="lg:hidden grid grid-cols-2 gap-0 border-t border-black/[0.06]">
              <div className="p-3 border-r border-black/[0.06] flex flex-col items-center justify-center gap-2">
                ...
                <button onClick={() => { MetaPixel.initiateCheckout(); setIsModalOpen(true); }}
                  className="w-full py-2.5 bg-[#E31E24] text-white rounded-lg font-display font-semibold text-xs hover:bg-[#c41a20] transition-all duration-300 shadow-lg shadow-[#E31E24]/20 flex items-center justify-center gap-1.5 cursor-pointer"
                  style={{ pointerEvents: 'auto' }}>
